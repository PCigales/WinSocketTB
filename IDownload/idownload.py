...
if len(sys.argv) <= 1:
  import winreg
  k = r'SOFTWARE\Mozilla\NativeMessagingHosts\idownload'
  winreg.SetValue(winreg.HKEY_CURRENT_USER, k, winreg.REG_SZ, os.path.join(os.path.dirname(os.path.abspath(globals().get('__file__', ' '))), 'idownload.json'))
